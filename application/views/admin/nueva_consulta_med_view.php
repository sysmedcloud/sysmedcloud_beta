                                          ...
                                          <div>
                                             <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingOne">
                                                   <h4 class="panel-title">
                                                      ...
                                                      <i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;&nbsp;Revisión por Sistemas 
                                                      </a>                                                      
                                                   </h4>
                                                   <br>
                                                </div>
                                             ...
                                             <div>
                                                <div class="panel panel-default">
                                                   <div class="panel-heading" role="tab" id="headingTwo">
                                                      <h4 class="panel-title">
                                                         <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                            <i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;&nbsp;Examen Físico
                                                         </a>
                                                      </h4>
                                                      <br>
                                                   </div>
                                                   ...
                                                   <br>
                                                   <input type="button" class="btn btn-white" id="ef_img" name="ef_img" 
                                                      value="Subir archivo">
                                                   </div>
                                                   <div class="col-sm-4" id="list_ef_archivos">
                                                   <ul>
                                                   </ul>
                                                   </div>
                                                   ...
                                                   <div class="modal-header">
                                                   <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                                   <h4 class="modal-title"><span id="nom_ef_archivo"></span></h4>
                                                   </div>
                                                   <div class="modal-body">
                                                   <img class="img-responsive" id="img_ef_arcivo">
                                                   </div>
                                                   <div class="modal-footer">
                                                   <button type="button" class="btn btn-white" data-dismiss="modal">Cerrar</button>
                                                   </div>
