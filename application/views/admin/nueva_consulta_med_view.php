<script type="text/javascript" src="http://localhost/sysmedcloud/js/fileinput.js" ></script>
<script type="text/javascript" src="http://localhost/sysmedcloud/js/locales/es.js" ></script>    
...
<script>
    $('#archivos').fileinput({
		...
		initialPreview: [
			<?php foreach($archivos as $archivo){
				...
				switch ($ext) {
					...
					case 'mp4': ?>
					'<video src="<?php echo $archivo; ?>" class="kv-preview-data file-preview-image" controls style="width:auto;height:160px;"><source src="foo.ogg" type="video/ogg"><source src="foo.mp4" type="video/mp4">Tu navegador no implementa el elemento <code>video</code>.<div class="file-preview-other"><span class="file-other-icon"><i class="glyphicon glyphicon-file"></i></span></div></video>',
					<?php break;
					case 'avi': ?>
					'<video src="<?php echo $archivo; ?>" class="kv-preview-data file-preview-image" controls style="width:auto;height:160px;"><source src="foo.ogg" type="video/ogg"><source src="foo.mp4" type="video/mp4">Tu navegador no implementa el elemento <code>video</code>.<div class="file-preview-other"><span class="file-other-icon"><i class="glyphicon glyphicon-file"></i></span></div></video>',
					<?php break;
					...
					case 'mp3': ?>
					'<audio controls="" class="kv-preview-data"><source type="audio/mpeg" src="<?php echo $archivo; ?>"></source><div class="file-preview-other"><span class="file-other-icon"><i class="glyphicon glyphicon-file"></i></span></div></audio>',
					<?php break;
					case 'wav': ?>
					'<audio controls="" class="kv-preview-data"><source type="audio/mpeg" src="<?php echo $archivo; ?>"></source><div class="file-preview-other"><span class="file-other-icon"><i class="glyphicon glyphicon-file"></i></span></div></audio>',
					<?php break;
					...
					case 'jpg': ?>
					'<img src="<?php echo $archivo; ?>" class="kv-preview-data file-preview-image" style="width:auto;height:160px;">',
					<?php break;
					case 'png': ?>
					'<img src="<?php echo $archivo; ?>" class="kv-preview-data file-preview-image" style="width:auto;height:160px;">',
					<?php break;
					...
					case 'pdf': ?>
					'<embed class="kv-preview-data" height="160px" width="160px" type="application/pdf" src="<?php echo $archivo; ?>">',
					<?php break;

					case 'xls': ?>
				    '<object height="160px" width="160px" type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" data="blob:http://localhost/616e086f-57f4-4e96-a161-cfac858de8e8" class="kv-preview-data file-object"><param value="<?php echo $archivo; ?>" name="movie"><param value="true" name="controller"><param value="true" name="allowFullScreen"><param value="always" name="allowScriptAccess"><param value="false" name="autoPlay"><param value="false" name="autoStart"><param value="high" name="quality"><div class="file-preview-other"><span class="file-other-icon"><a href="<?php echo $archivo; ?>"  target="_blanck"><i class="glyphicon glyphicon-file"></i></a></span></div></object>',
					<?php break;
					case 'xlsx': ?>
				    '<object height="160px" width="160px" type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" data="blob:http://localhost/616e086f-57f4-4e96-a161-cfac858de8e8" class="kv-preview-data file-object"><param value="<?php echo $archivo; ?>" name="movie"><param value="true" name="controller"><param value="true" name="allowFullScreen"><param value="always" name="allowScriptAccess"><param value="false" name="autoPlay"><param value="false" name="autoStart"><param value="high" name="quality"><div class="file-preview-other"><span class="file-other-icon"><a href="<?php echo $archivo; ?>"  target="_blanck"><i class="glyphicon glyphicon-file"></i></a></span></div></object>',
					<?php break;
		...
		{caption: "<?php echo $infoArchivos[1];?>",  height: "120px", url: "borrar.php", key:"<?php echo $infoArchivos[1];?>"},
		<?php } ?>
		]
