...
<head>
    ...
    <link href="<?php echo base_url(); ?>css/plugins/dataTables/dataTables.bootstrap.css" media="all" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>css/plugins/dataTables/dataTables.responsive.css" media="all" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>css/plugins/dataTables/dataTables.tableTools.min.css" media="all" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo base_url(); ?>js/ficha_clinica.js" type="text/javascript"></script>
