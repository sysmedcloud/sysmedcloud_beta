        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!--<li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/a7.jpg">
                                </a>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/a4.jpg">
                                </a>
                                <div class="media-body ">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/profile.jpg">
                                </a>
                                <div class="media-body ">
                ...
                <li>
                    <a href="<?=base_url();?>login_app/accion/logout">
